export const ENVIRONMENT = {
  ...
  SAFEHAVEN: {
    URL: Bun.env.SAFE_HAVEN_URL,
    CLIENT_ASSERTION_TYPE: Bun.env.SAFE_HAVEN_CLIENT_ASSERTION_TYPE,
    CLIENT_ID: Bun.env.SAFE_HAVEN_CLIENT_ID,
    CLIENT_ASSERTION: Bun.env.SAFE_HAVEN_CLIENT_ASSERTION,
